...
try:
    ...
    slider_element = driver.find_element(By.XPATH, '//span[contains(@class, "MuiSlider-thumb")]')

    action = ActionChains(driver)
    action.click_and_hold(slider_element).move_by_offset(xoffset= 94, yoffset=0).release().perform()
    time.sleep(2)
